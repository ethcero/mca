...
public class OrderController {
  ...
  public CreateOrderResponse createOrder(@RequestBody CreateOrderRequest createOrderRequest) {
    Order order = orderService.createOrder(new OrderDetails(createOrderRequest.getCustomerId(),createOrderRequest.getProductId(), createOrderRequest.getQuantity(), createOrderRequest.getOrderTotal()));
  ...
  public ResponseEntity<GetOrderDetailsResponse> getOrderDetails(@PathVariable Long orderId) {
    return orderRepository
            .findById(orderId)
            .map(o -> new ResponseEntity<>(new GetOrderDetailsResponse(
